# Affordable Housing Fund (AHF) / Build Canada Homes
**Type**: Policy (federal grant program)
...
## Relationships
- `depends-on` ← [[sapperton-district-project]] (Phase 2+)
- Layers on [[cmhc-aclp]] / [[mli-select]] stack

## Tensions
- None

## Open questions
- AHF eligibility mechanics under Build Canada Homes as of 2026 — sponsor docs assert alignment, not confirmed
- Do healthcare-worker incomes actually clear "income-qualified" thresholds for below-market units?
